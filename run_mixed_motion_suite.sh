...
FPS="${FPS:-44}"
SCENARIO="${SCENARIO:-$HIL_DIR/scenarios/mixed_fades_jumps_speed_accel.csv}"
...
echo "[INFO] Running mixed motion DMX suite against the already running Pico"
echo "[INFO] Vision axis: $AXIS"
echo "[INFO] Scenario: $SCENARIO"
echo "[INFO] Duration: ${DURATION}s"
echo "[INFO] Vision enabled: $WITH_VISION"
echo "[INFO] DMX FPS: $FPS"
echo "[INFO] This sends fades, jumps, and DMX speed/acceleration changes only"
...
echo "[PASS] Mixed motion DMX suite completed"
